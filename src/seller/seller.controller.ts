...
export class SellerController {
    constructor(private sellerService: SellerService, @Inject(CACHE_MANAGER) private cacheManager: Cache, private imagesService: ImageProcessingService, private userService: UserService, private productService: ProductService, private storeService: StoreService) { }
    ...
    @ApiOperation({
        ...
        description: 'Get detailed information about a specific product in a store (Seller only)'
    })
    @ApiParam({
        name: 'storeId',
        description: '[PARAM] Store ID (MongoDB ObjectId)',
